...
export const ListProjectsResponseItem = zod.object({
  ...
  shortDescriptionEn: zod.string().nullish(),
  fullDescriptionEn: zod.string().nullish(),
  problemEn: zod.string().nullish(),
  solutionEn: zod.string().nullish(),
  resultEn: zod.string().nullish(),
