...
export const translations = {
  pt: {
    ...
    home: {
      ...
      metrics: [
        { value: "+10", label: "Projetos técnicos entregues" },
        { value: "Full Stack", label: "Web · Dados · Automação" },
        { value: "Docker + VPS", label: "Deploy & Infra" },
        { value: "BI + APIs", label: "Dados & Integrações" },
      ],
      techMarqueeLabel: "Stack",
      expertisePreviewLabel: "Especialidades",
      expertisePreviewCta: "Ver todas as especialidades",
      featuredLabel: "Projeto em destaque",
      featuredEmptyTitle: "Projetos em breve",
      featuredEmptyDesc: "Cadastre projetos no painel para exibi-los aqui.",
      viewProject: "Ver projeto",
      projectsPreviewLabel: "Portfólio",
      projectsPreviewCta: "Ver todos os projetos",
      experiencePreviewLabel: "Experiência",
      experiencePreviewRole: "Dev Full Stack B2B",
      experiencePreviewCta: "Ver trajetória completa",
      contactCtaTitle: "Tem um processo travando sua operação?",
      contactCtaSubtitle: "Posso transformar isso em sistema. Fala comigo.",
      contactCtaBtn: "Entrar em contato",
    },
    projects: {
    ...
    experience: {
      heroSubtitle: "Histórico de trabalhos, projetos e entregas técnicas.",
      heroCta: "Ver Projetos",
      timelineTitle: "Trajetória",
      highlightsTitle: "Trabalhos Relevantes",
      ctaTitle: "Quer ver o que foi construído?",
      ctaText: "Os projetos documentados mostram o resultado prático de cada entrega.",
      ctaBtn: "Ver Projetos",
      currentLabel: "Atual",
      presentLabel: "presente",
      techLabel: "Tecnologias",
      responsibilitiesLabel: "Responsabilidades",
      resultsLabel: "Entregas",
    },
  },
  ...
  en: {
    ...
    home: {
      ...
      metrics: [
        { value: "+10", label: "Technical projects delivered" },
        { value: "Full Stack", label: "Web · Data · Automation" },
        { value: "Docker + VPS", label: "Deploy & Infra" },
        { value: "BI + APIs", label: "Data & Integrations" },
      ],
      techMarqueeLabel: "Stack",
      expertisePreviewLabel: "Specialties",
      expertisePreviewCta: "View all specialties",
      featuredLabel: "Featured project",
      featuredEmptyTitle: "Projects coming soon",
      featuredEmptyDesc: "Add projects in the admin panel to display them here.",
      viewProject: "View project",
      projectsPreviewLabel: "Portfolio",
      projectsPreviewCta: "View all projects",
      experiencePreviewLabel: "Experience",
      experiencePreviewRole: "Full Stack Dev B2B",
      experiencePreviewCta: "View full timeline",
      contactCtaTitle: "Have a process slowing down your operations?",
      contactCtaSubtitle: "I can turn it into a system. Let's talk.",
    ...
    experience: {
      heroSubtitle: "Work history, projects and technical deliveries.",
      heroCta: "View Projects",
      timelineTitle: "Timeline",
      highlightsTitle: "Relevant Work",
      ctaTitle: "Want to see what was built?",
      ctaText: "The documented projects show the practical outcome of each delivery.",
